...
logging.basicConfig(filename='extend_era5_v.log', filemode='w', level=logging.DEBUG, format='%(process)d-%(levelname)s-%(message)s')
...
#i.main(start = '1979-01-01', end = '2020-10-25')
j.main(start = '1979-01-01', end = '2020-10-24')
